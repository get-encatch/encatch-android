        ...
        Column(Modifier.fillMaxWidth().padding(12.dp)) {
            TesterCard {
                Column(
                    ...
                    SecondaryPillButton("Add row", onClick = { rows = rows + PrefillRow() })
                    ...
                    QuietTextButton("Cancel", onClick = onDismiss, color = MaterialTheme.colorScheme.onSurfaceVariant)
                }
            }
        }
    }
...
private fun PrefillRowEditor(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        ...
        Row(verticalAlignment = androidx.compose.ui.Alignment.CenterVertically) {
            SecondaryPillButton("Type: ${row.type.label}", onClick = onPickType)
        }
