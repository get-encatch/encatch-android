...
/// (`FormAppearanceKt`/`FormThemeColorKt`) — mirrors `:android`'s `FormAppearanceAndroid.kt`.
...
/// Converts a packed ARGB `Int32` (as produced by `FormThemeColorKt.parseCssColorToArgb`) into a
/// `UIColor`.
