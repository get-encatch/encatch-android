...
// (e.g. `:core`) is shaped.
//
// iOS cinterops directly against swift/'s pure-Swift SDK via the @objc facade in
// swift/Sources/Encatch/ObjCBridge/EncatchBridge.swift, the same way compose-sample/kmp-sample
...
// swift/dist/ (cinterop static lib + ObjC header) via swift/build-dist.sh so a fresh
