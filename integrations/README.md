...
| [`encatch-ios-tester`](encatch-ios-tester/README.md) | `swift` (Swift Package) |
| [`encatch-mac-tester`](encatch-mac-tester/README.md) | `swift` (Swift Package, Mac Catalyst) |
...
`swift` package, but with a genuinely Mac-native UI (sidebar, real Preferences window,
