...
> `from: "0.1.1"` rule will only auto-update patch releases, which is the safe default.
...
`swift/`); this repo is the Swift Package Manager distribution mirror, updated per release.
